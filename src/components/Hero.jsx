...
export default function Hero() {
  const words = [
    ...
    "Competitive Programmer on Codeforces & AtCoder",
    "Exploring System Design and Distributed Systems",
    "Hands-on with Docker, AWS, and Redis",
...
const profile = {
    name: 'Md. Al - Amin',
    title: 'Software Engineer | Backend Enginner | Problem Solver',
    skills: [
        'React', 'Python', 'JavaScript', 'Express',
        'Django', 'MongoDB', 'MySql', 'AWS', 'Docker',
        'REST Api', 'Git', 'RabbitMQ', 'Redis'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Problem Solver 🚀 | Software Engineer 🔧 | Learning Data
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1sKUN5oFGvvlCAhzEyYHEfFddK4KnCsIk/view"
                  target="_blank"
                  rel="noopener noreferrer"
